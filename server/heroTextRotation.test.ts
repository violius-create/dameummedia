...
describe("heroTextRotation", () => {
  ...
  describe("getHeroTextRotation", () => {
    ...
    it("should return hero text rotation data when it exists", async () => {
      const mockData = {
        id: 1,
  ...
  describe("upsertHeroTextRotation", () => {
    it("should create new hero text rotation settings", async () => {
      const input = {
        text1Title: "Title 1",
    ...
    it("should update existing hero text rotation settings", async () => {
      const input = {
