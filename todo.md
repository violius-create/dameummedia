...
## 예약하기 양식 결제방식 및 계산서 발행 수정 (2026-02-04 완료)
- [x] Reservation.tsx에서 결제방식을 라디오버튼 형태로 한줄로 변경 (카드, 계좌이체, 현금)
...
## 섹션 2, 3 렌더링 문제 수정 (2026-02-04 완료)
- [x] Home.tsx에서 섹션 2, 3이 제대로 표시되지 않는 문제 진단 (비디오 URL 문제)
- [x] 섹션 2, 3 렌더링 로직 수정 (비디오에서 이미지로 변경)
- [x] 테스트 및 검증
